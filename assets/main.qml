...
Page {
    ...
    property variant currentWorkout: ["1", "2", "3", "4", "5", "6", "7", "8"]
    ...
    Container {
        ...
        Container {
			...
			// countdownlabel should expose a state or similar
			//
			// caller "sets" callback functions when starting, then write a workout "driver" that continually sets and listens to countdown_label
            CountdownLabel {
                id: countdown_label
                //time: 10
                //time: 2
